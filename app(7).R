...
ui <- dashboardPage(  skin = "red",
                      ...
                      dashboardSidebar(
                        sidebarMenu(
                          ...
                          menuItem("Global Info",tabName="page2",icon=icon("flag-checkered")),
                          menuItem("Constructor", tabName = "page3", icon = icon("car")),
                          menuItem("Driver", tabName = "page4", icon = icon("user")),
                          menuItem("Circuit",tabName="page5",icon=icon("road")),
                          menuItem("Data Source",tabName= "page6", icon=icon("database"))
                        )
                      ),
                      dashboardBody(
                        #Page 1
                                ...
                                column(12,
                                       tags$div(fluidRow(
                                         column(
                                           ...
                                           br(),
                                           a(
                                             h5("Source", href = 'https://corp.formula1.com/about-f1')
                                           )
                                         ),
                                         
                                         column(4, img(src = "https://logok.org/wp-content/uploads/2014/06/Formula-1-logo-2017-logotype.png ", width =
                                                         30,
                           ...
                           in the",
                            ...
                            fluidRow(
                              ...
                              box(
                                ...
                                width = 12,
                                collapsible = TRUE,
                                selectInput(inputId="Driver", label="Drivers",choices=c(""),width = "200px"),
                                fluidRow(
